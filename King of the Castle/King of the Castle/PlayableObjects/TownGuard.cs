...
{
    public class TownGuard : IPlayableObjectState
    {
        ...
        public TownGuard(IPlayableObject playableObject)
        {
            this.parent = playableObject;
            this.Position = parent.Position;

            sprite = AnimatedSpriteFactory.Instance.BuildTownGuardSprite(parent.Position);
